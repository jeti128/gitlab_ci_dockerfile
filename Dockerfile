...
MAINTAINER jeti128 <jeti128@gmail.com>
LABEL vendor="gitlab_ci_dockerfile"
...
RUN curl https://deb.nodesource.com/node_12.x/pool/main/n/nodejs/nodejs_12.0.0-1nodesource1_amd64.deb > node.deb \
 && dpkg -i node.deb \
 && rm node.deb